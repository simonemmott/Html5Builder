...
/**
 * This abstract element defines a flow element that disallows header, footer and address elements
 * 
 * This class adds the methods to create the child elements appropriate to flow elements excluding header, footer and address elements
 * 
 * @author simon
 *

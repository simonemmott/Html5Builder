...
/**
 * This absract class extends HtmlElement adding the methods to create the common phrasing elements
 * and child elements
 * @author simon
 *
...
public abstract class HtmlCommonPhrasingElement<T extends XMLElement> extends HtmlElement<T> {
	 ...
	 */
	protected HtmlCommonPhrasingElement(Html5Builder hb, String tag) {
		super(hb, tag);
	}
	...
	/**
	 * Create an 'textarea' element as a child of this element
	 * @return The created child element
	 */
	public HtmlTextArea textArea() { return createAndAddChild(HtmlTextArea.class); }
	/**
	 * Create an 'time' element as a child of this element
	 * @return The created child element
	 */
	public HtmlTime time() { return createAndAddChild(HtmlTime.class); }
	/**

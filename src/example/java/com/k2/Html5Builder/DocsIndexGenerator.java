...
public class DocsIndexGenerator {
				...
				.section()
					...
					.div()
						...
						.p()
							...
							.up(HtmlDiv.class)
						.p()
							.text("The a sample page can be viewed")
						...
						.p()
							...
							.a().setHref("https://simonemmott.github.io/Html5Builder/heading-sample.html").text("here").up(HtmlP.class)
							.page()
